...
//    func get(_ query: String) -> (v: Published<Array<ProductDB>>.Publisher, f: Published<Bool>.Publisher)
//    func nextPage(lastIt: ProductDB) -> Published<Array<ProductDB>>.Publisher
//}
//
...
//    
//    @Published private var list: Array<ProductDB> = []
